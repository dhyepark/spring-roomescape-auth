...
public class ThemeController {
    ...
    @PostMapping("/themes")
    public ResponseEntity<ThemeResponseDto> create(@RequestBody @Valid ThemeSaveRequestDto themeRequest) {
        ThemeResponseDto body = ThemeResponseDto.from(themeService.create(themeRequest.toServiceDto()));
