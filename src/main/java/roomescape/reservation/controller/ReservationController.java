...
public class ReservationController {
    ...
    @GetMapping
    public ResponseEntity<List<ReservationResponseDto>> getByMemberId(@RequestParam Long memberId) {
        List<ReservationResponseDto> body = reservationService.getByMemberId(memberId).stream()
